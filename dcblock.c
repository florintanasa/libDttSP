...
butterworth_hipass_100_2(REAL xin, REAL *xv, REAL *yv)
{
    ...
    for (i = 1; i < 2; i++) xv[i - 1] = xv[i], yv[i - 1] = yv[i];

    xv[2] = (REAL)(xin / 1.009297482);

    yv[2] = (REAL)((xv[0] + xv[2])
                   + -2.0 * xv[1]
                   + -0.9816611902 * yv[0] + 1.9814914708 * yv[1]);
...
butterworth_hipass_100_4(REAL xin, REAL *xv, REAL *yv)
{
    ...
    for (i = 1; i < 4; i++) xv[i - 1] = xv[i], yv[i - 1] = yv[i];
    ...
    yv[4] = (REAL)((xv[0] + xv[4])
                   ...
                   + -0.976340271 * yv[0]
                   + 3.928738552 * yv[1]
                   + -5.928454312 * yv[2] + 3.976056024 * yv[3]);
...
butterworth_hipass_100_6(REAL xin, REAL *xv, REAL *yv)
{
    ...
    for (i = 1; i < 6; i++) xv[i - 1] = xv[i], yv[i - 1] = yv[i];
    ...
    yv[6] = (REAL)((xv[0] + xv[6])
                   ...
                   + -14.5019247580 * yv[2]
                   + 19.4994114580 * yv[3]
                   + -14.7484389800 * yv[4] + 5.9494324049 * yv[5]);
...
butterworth_hipass_100_8(REAL xin, REAL *xv, REAL *yv)
{
    ...
    for (i = 1; i < 8; i++) xv[i - 1] = xv[i], yv[i - 1] = yv[i];
    ...
    yv[8] = (REAL)((xv[0] + xv[8])
                   ...
                   + -67.6854640540 * yv[4]
                   + 54.6046308830 * yv[5]
                   + -27.5326449810 * yv[6] + 7.9329138172 * yv[7]);
